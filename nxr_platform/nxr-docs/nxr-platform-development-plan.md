...
- Phase 3:
  - customer registration/login uses a dedicated customer session header and does not share RuoYi staff credentials
  - collector card binding and transfer history are available from the Vue public site; comments, ratings, and card memories are intentionally out of scope
  - staff can list customer accounts, inspect card and order history, enable or disable an account, and revoke customer sessions without deleting business records
