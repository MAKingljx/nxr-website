...
<template>
  ...
  <main class="portal-page">
    <div class="portal-heading"><div><p class="section-tag">Collector portal</p><h1>My Grading Orders</h1><p>Payment, receiving, grading and return-shipment status in one place.</p></div><router-link class="btn-secondary" to="/account/cards">My cards</router-link></div>
