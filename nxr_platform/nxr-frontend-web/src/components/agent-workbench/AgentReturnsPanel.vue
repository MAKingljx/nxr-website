...
import {
  agentAddressLabel, agentDateLabel, agentStatusLabel, checkAgentReturn, createAgentShipment, deliverAgentShipment, normalizeAgentReturnScan,
  emptyAgentAddress, emptyAgentPage, fetchAgentCards, fetchAgentShipment, fetchAgentShipments, useAgentActions,
...
async function checkReturn() {
  ...
  const payload = { inventoryCode: normalizeAgentReturnScan(scan.inventoryCode), note: scan.note.trim() }
