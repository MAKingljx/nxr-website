...
export const WORKSPACE_VIEWS = Object.freeze(['clients', 'cards', 'intakes', 'batches', 'returns', 'wallet', 'addresses'])
...
const VIEW_ICONS = { clients: 'user', cards: 'post', intakes: 'clipboard', batches: 'list', returns: 'tree-table', wallet: 'money', addresses: 'guide' }
