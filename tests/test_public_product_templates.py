...
class PublicProductTemplateTests(unittest.TestCase):
    ...
    def test_missing_product_type_keeps_graded_card_contract(self):
        ...
        self.assertIn("Measures how evenly the image is positioned within the borders.", html)
        self.assertIn("Evaluates the condition of all four edges.", html)
        self.assertIn("Assesses sharpness and wear on all four corners.", html)
        self.assertIn("Checks for scratches, print defects, stains, or other surface imperfections.", html)
